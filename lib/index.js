...
var Skeleton = {
    VERSION: '2.1.30',
    PUBLIC_PATH:  false ? "/" : "https://assets.au.stackchat.com/sdk/web-messenger/2.1.30/",
    on: function on() {
    ...
    init: function init() {
        ...
        if (args[0].region === "cn") {
            ...
            this.PUBLIC_PATH = "https://assets.common.stackchat.com.cn/sdk/web-messenger/2.1.30/";
        }
...
function injectHostStyles(region) {
    ...
    link.rel = 'stylesheet';
    link.type = 'text/css';
    link.href = region === "cn" ? 'https://assets.common.stackchat.com.cn/sdk/web-messenger/2.1.30/stackchat.2.1.30.css' : 'https://assets.au.stackchat.com/sdk/web-messenger/2.1.30/stackchat.2.1.30.css';
...
function injectFrame(region) {
    ...
    if (!iframe) {
        ...
        var frameCssUrl = region === "cn" ? 'https://assets.common.stackchat.com.cn/sdk/web-messenger/2.1.30/frame.2.1.30.css' : 'https://assets.au.stackchat.com/sdk/web-messenger/2.1.30/frame.2.1.30.css';
        var frameJsUrl = region === "cn" ? 'https://assets.common.stackchat.com.cn/sdk/web-messenger/2.1.30/frame.2.1.30.min.js' : 'https://assets.au.stackchat.com/sdk/web-messenger/2.1.30/frame.2.1.30.min.js';
